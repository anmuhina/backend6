          ...
          foreach ($values as $val) {
                  ...
                  '<tr>
                      ...
                      <td> <select name="abilities'.$val['id'].'[]" multiple="multiple"> 
                           <option value="Бессмертие"'; if (in_array(10, unserialize($abil))) {print 'selected="selected"';} print '>Бессмертие</option>
                           <option value="Прохождение сквозь стены"'; if (in_array(20, unserialize($abil))) {print 'selected="selected"';} print '>Прохождение сквозь стены</option>
                           <option value="Левитация"'; if (in_array(30, unserialize($abil))) {print 'selected="selected"';} print '>Левитация</option>
                      </td>
                      ...
                      <td> <div> <input name="save'.$val['id'].'" type="submit" value="Сохранить изменения для пользователя '.$val['id'].'"> </div>
                           <div> <input name="delete'.$val['id'].'" type="submit" value="Удалить пользователя '.$val['id'].'"> </div>
                      </td>
                  </tr>';
          }
          ?>
