          ...
          foreach ($values as $val) {
                  ...
                  '<tr>
                      ...
                      <td> <select name="abilities'.$val['id'].'[]" multiple="multiple"> 
                           <option value="Бессмертие"'; if (in_array(10, $val['abilities'])) {print 'selected="selected"';} print '>Бессмертие</option>
                           <option value="Прохождение сквозь стены"'; if (in_array(20, $val['abilities'])) {print 'selected="selected"';} print '>Прохождение сквозь стены</option>
                           <option value="Левитация"'; if (in_array(30, $val['abilities'])) {print 'selected="selected"';} print '>Левитация</option>
                      </td>
